/* ================================================
   ai_document-views.js
   Gerenciadores de Visualização: Visão Estruturada (Outline) e Minuta
   ================================================ */
...
window.MinutaViewManager = (function() {
    ...
    const INTENCOES_PERMITIDAS = ['comando', 'texto', 'premissa', 'preliminar', 'refutacao', 'fundamentacao'];
